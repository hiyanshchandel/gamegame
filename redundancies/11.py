...
# Define obstacles (placed on platforms) at different positions
obstacles = [
    ...
    pygame.Rect(5300, 420, 30, 30),
    pygame.Rect(7200, 380, 30, 30),
    pygame.Rect(8300, 460, 30, 30),
    pygame.Rect(12300, 420, 30, 30),
    pygame.Rect(14300, 380, 30, 30),
]
...
while True:
    ...
    # Display the score both in gameplay and on the Game Over screen
    ...
    if game_over:
        ...
        screen.blit(score_text, (320, 250))  # Display final score
        screen.blit(retry_text, (320, 300))
